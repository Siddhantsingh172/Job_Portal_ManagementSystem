...
public class OpenApiConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                ...
                .info(new Info().title("Job Portal - Notification Service").version("1.0.0").description("Notification APIs").contact(new Contact().name("Job Portal Team").email("api@jobportal.com")))
